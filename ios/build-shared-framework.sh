...
echo "  - Device: shared/build/xcodegen/Release/SharedModule/Release-iphonearm/SharedModule.framework"
echo "  - Simulator (x64): shared/build/xcodegen/Release/SharedModule/Release-iphonesimulator/SharedModule.framework"
echo "  - Simulator (arm64): shared/build/xcodegen/Release/SharedModule/Release-iphonesimulatorarm64/SharedModule.framework"
echo ""
echo "Next steps:"
