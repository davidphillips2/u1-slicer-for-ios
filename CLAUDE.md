...
### Unit tests (`app/src/test/`) - 437 tests across 27 classes
...
- `network/MoonrakerClientTest.kt` (29) — PrinterStatus computed properties, URL normalization, LED state, remoteScreenUrl()
