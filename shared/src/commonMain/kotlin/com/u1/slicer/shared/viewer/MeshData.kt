...
/**
 * Holds interleaved vertex data for 3D rendering.
 * Format per vertex: x, y, z, nx, ny, nz, r, g, b, a (10 floats = 40 bytes)
 *
 * Note: For KMP compatibility, we use FloatArray instead of FloatBuffer.
 * The platform-specific implementations will handle conversion to the appropriate buffer type.
 */
data class MeshData(
    val vertices: FloatArray,  // Interleaved position + normal + color
    val vertexCount: Int,
    ...
    companion object {
        ...
        fun allocateArray(triangleCount: Int): FloatArray {
