...
data class SlicingOverrides(
    ...
    fun resolvePrimeTower(extCount: Int, cfgWipeTower: Boolean): Boolean {
        ...
        return when (primeTower.mode) {
            ...
            OverrideMode.ORCA_DEFAULT -> ORCA_DEFAULTS["primeTower"] as? Boolean ?: cfgWipeTower
    ...
    fun resolveInto(base: SliceConfig): SliceConfig {
        fun <T> res(ov: OverrideValue<T>, baseVal: T, defaultKey: String): T =
            when (ov.mode) {
                ...
                OverrideMode.ORCA_DEFAULT -> ORCA_DEFAULTS[defaultKey] as? T ?: baseVal
    ...
    companion object {
        ...
        fun fromJson(jsonString: String): SlicingOverrides {
            return try {
                json.decodeFromString<SlicingOverrides>(jsonString)
            } catch (_: Exception) {
                SlicingOverrides()
            }
        }
